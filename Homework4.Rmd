...
#### e. Let $m$ be the median of the posterior distribution for $k$. Create a time series plot of the counts where the first 𝑚 years are shown in blue, while the remaining years are shown in orange. This distinguishes the years where we have a Poisson($\lambda$) from a Poisson($\phi$) distribution. \break
